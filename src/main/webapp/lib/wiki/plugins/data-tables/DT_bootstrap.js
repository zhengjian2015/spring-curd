	...
	"bootstrap": {
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			$(nPaging).addClass('pagination').append(
				'<ul>'+
					'<li class="firt"><a href="#"><span class="hidden-480">'+oLang.sFirst+'</span></a></li>'+
					...
					'<li class="last"><a href="#"><span class="hidden-480">'+oLang.sLast+'</span></a></li>'+
				'</ul>'
			);
			var els = $('a', nPaging);
		...
		"fnUpdate": function ( oSettings, fnDraw ) {
			...
			for ( i=0, iLen=an.length ; i<iLen ; i++ ) {
				...
				// console.log(js(oPaging.iPage)+','+js(oPaging.iTotalPages));
				if (oPaging.iTotalPages < 0) { // 2015-07-20 jincw: 解决页大小为-1(对应“全部”)时iTotalPages为负数的bug
					oPaging.iTotalPages = 1;
				}
