...
!function ($) {
  ...
  var loading = "<img src='../img/ajax-loader.gif' class='indicator' /> Loading ...";
  ...
  $(function () {
    ...
    $("body").on("click.tree.data-api", "[data-toggle=branch]", function (e) {
      ...
      //alert(option+','+option.parent);
      if (option!=='toggle') {
        option.parent = $this // Uncaught TypeError: Cannot assign to read only property 'parent' of toggle
        option.href = (href !== "#") ? href : undefined
        // Uncaught TypeError: Cannot assign to read only property 'href' of toggle
      }
