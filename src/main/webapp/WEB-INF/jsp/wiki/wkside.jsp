...
<div class="span3 blog-sidebar">
    ...
    <c:if test="${not empty listArt}">
	    <h3>相关文章</h3>
	       <c:forEach items="${listArt}" var="l">
	         <div class="blog-twitter-block">
	               <a href="${pageContext.request.contextPath}/wiki/wkv2/${l.artId}">${l.artTitle}</a>
